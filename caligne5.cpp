...
void CAligne5::OrdiJoue()
{
    ...
    switch( retour )
    {
        case ORDIFIN :
            ...
            faitTemporisation();
/*			QMessageBox::information( this, NOM_PROG + tr(" - Perdu"),
                                    QString(tr(" DÉSOLÉ !"
                                             "\n\n Partie gagnée par l'ordinateur. \n")) );*/
            cloturePartie( ORDIFIN );
            break;
        case PARTIENULLE :
/*			QMessageBox::information( this, NOM_PROG + tr(" - Égalité"),
...
void CAligne5::clicBoutonGauche()
{
    ...
    switch( retour )
    {
        case HUMAINFIN :
            ...
            faitTemporisation();
/*			QMessageBox::information( this, NOM_PROG + tr(" - Gagné"),
                                      QString(tr(" BRAVO !"
...
void CAligne5::slotDebutPartie()
{
    if ( true == m_fPartie )
    {
        QMessageBox::information( this, NOM_PROG + tr(" - Jouer"),
...
{
    QMessageBox::information( this, NOM_PROG + tr(" - Aide"),
...
void CAligne5::slotArretPartie()
{
    if( m_pcJeu->fournirPeriodeJeu() == HUMAINJOUE )
    {
        int reponse = QMessageBox::question ( this, NOM_PROG + tr(" - Arrêter"),
                                                    tr(" Arrêter la partie en cours ? \n"),
                                                    tr("Continuer"),	/// index 0
                                                    tr("Arrêter")		/// index 1
                                                    );
        ...
        switch ( reponse )
        {
            ...
            case 1 : cloturePartie ( ARRETPARTIE ); break; /// Arrêter
        }
    }
}
...
{
    int reponse = QMessageBox::question ( this, NOM_PROG + tr(" - Quitter"),
                                                tr(" Quitter le jeu %1 ? \n").arg( NOM_PROG ),
                                                tr("Continuer"),	/// index 0
                                                tr("Quitter")       /// index 1
                                                );
...
void CAligne5::closeEvent( QCloseEvent *event )
{
    ...
    int reponse = QMessageBox::question ( this, NOM_PROG + tr(" - Fermer"),
                                                tr(" Fermer le jeu Aligne5 ? "),
                                                tr("Annuler"),	/// index 0
                                                tr("Fermer")	/// index 1
                                                );
    ...
    switch ( reponse )
    {
        case 0 :
            ...
            event->ignore();
            break;                      /// Continuer
        case 1 : event->accept();	break;	/// Arrêter
    }
}
